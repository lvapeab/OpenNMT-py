...
def trainslate_opts(parser):
    """ Translation / inference + Training options """

    group = parser.add_argument_group('Data')
    group.add_argument('-data_type', default="text",
                       help="Type of the source input. Options: [text|img].")
    group.add_argument('-data', required=True,
                       help="""Path prefix to the ".train_online.pt" file path from preprocess.py""")
    ...
    group.add_argument('-train_from', default='', type=str, required=True,
                       help="""If training from a checkpoint then this is the
                       path to the pretrained model's state_dict.""")
